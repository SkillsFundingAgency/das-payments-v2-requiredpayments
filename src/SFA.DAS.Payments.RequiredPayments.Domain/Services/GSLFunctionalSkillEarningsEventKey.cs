...
{
    public class GSLFunctionalSkillEarningsEventKey : EarningEventKey
    {
        public Guid ExternalEarningsId { get; }
        public Guid EventId { get; }
        public string CourseCode { get; }
        protected GSLFunctionalSkillEarningsEventKey() { }
        public GSLFunctionalSkillEarningsEventKey(GSLFunctionalSkillEarningsEvent earningEvent) : base(earningEvent)
        {
